...
/-! Equations list, numbers 4000-4999 -/
...
equation 4696 := x = x ◇ (x ◇ (x ◇ (x ◇ (x ◇ y))))
equation 4697 := x = x ◇ (x ◇ (x ◇ (x ◇ (y ◇ x))))
equation 4698 := x = x ◇ (x ◇ (x ◇ (x ◇ (y ◇ y))))
equation 4699 := x = x ◇ (x ◇ (x ◇ (x ◇ (y ◇ z))))
equation 4700 := x = x ◇ (x ◇ (x ◇ (y ◇ (x ◇ x))))
equation 4701 := x = x ◇ (x ◇ (x ◇ (y ◇ (x ◇ y))))
equation 4702 := x = x ◇ (x ◇ (x ◇ (y ◇ (x ◇ z))))
equation 4703 := x = x ◇ (x ◇ (x ◇ (y ◇ (y ◇ x))))
equation 4704 := x = x ◇ (x ◇ (x ◇ (y ◇ (y ◇ y))))
equation 4705 := x = x ◇ (x ◇ (x ◇ (y ◇ (y ◇ z))))
equation 4706 := x = x ◇ (x ◇ (x ◇ (y ◇ (z ◇ x))))
equation 4707 := x = x ◇ (x ◇ (x ◇ (y ◇ (z ◇ y))))
equation 4708 := x = x ◇ (x ◇ (x ◇ (y ◇ (z ◇ z))))
equation 4709 := x = x ◇ (x ◇ (x ◇ (y ◇ (z ◇ w))))
equation 4710 := x = x ◇ (x ◇ (y ◇ (x ◇ (x ◇ x))))
equation 4711 := x = x ◇ (x ◇ (y ◇ (x ◇ (x ◇ y))))
equation 4712 := x = x ◇ (x ◇ (y ◇ (x ◇ (x ◇ z))))
equation 4713 := x = x ◇ (x ◇ (y ◇ (x ◇ (y ◇ x))))
equation 4714 := x = x ◇ (x ◇ (y ◇ (x ◇ (y ◇ y))))
equation 4715 := x = x ◇ (x ◇ (y ◇ (x ◇ (y ◇ z))))
equation 4716 := x = x ◇ (x ◇ (y ◇ (x ◇ (z ◇ x))))
equation 4717 := x = x ◇ (x ◇ (y ◇ (x ◇ (z ◇ y))))
equation 4718 := x = x ◇ (x ◇ (y ◇ (x ◇ (z ◇ z))))
equation 4719 := x = x ◇ (x ◇ (y ◇ (x ◇ (z ◇ w))))
equation 4720 := x = x ◇ (x ◇ (y ◇ (y ◇ (x ◇ x))))
equation 4721 := x = x ◇ (x ◇ (y ◇ (y ◇ (x ◇ y))))
equation 4722 := x = x ◇ (x ◇ (y ◇ (y ◇ (x ◇ z))))
equation 4723 := x = x ◇ (x ◇ (y ◇ (y ◇ (y ◇ x))))
equation 4724 := x = x ◇ (x ◇ (y ◇ (y ◇ (y ◇ y))))
equation 4725 := x = x ◇ (x ◇ (y ◇ (y ◇ (y ◇ z))))
equation 4726 := x = x ◇ (x ◇ (y ◇ (y ◇ (z ◇ x))))
equation 4727 := x = x ◇ (x ◇ (y ◇ (y ◇ (z ◇ y))))
equation 4728 := x = x ◇ (x ◇ (y ◇ (y ◇ (z ◇ z))))
equation 4729 := x = x ◇ (x ◇ (y ◇ (y ◇ (z ◇ w))))
equation 4730 := x = x ◇ (x ◇ (y ◇ (z ◇ (x ◇ x))))
equation 4731 := x = x ◇ (x ◇ (y ◇ (z ◇ (x ◇ y))))
equation 4732 := x = x ◇ (x ◇ (y ◇ (z ◇ (x ◇ z))))
equation 4733 := x = x ◇ (x ◇ (y ◇ (z ◇ (x ◇ w))))
equation 4734 := x = x ◇ (x ◇ (y ◇ (z ◇ (y ◇ x))))
equation 4735 := x = x ◇ (x ◇ (y ◇ (z ◇ (y ◇ y))))
equation 4736 := x = x ◇ (x ◇ (y ◇ (z ◇ (y ◇ z))))
equation 4737 := x = x ◇ (x ◇ (y ◇ (z ◇ (y ◇ w))))
equation 4738 := x = x ◇ (x ◇ (y ◇ (z ◇ (z ◇ x))))
equation 4739 := x = x ◇ (x ◇ (y ◇ (z ◇ (z ◇ y))))
equation 4740 := x = x ◇ (x ◇ (y ◇ (z ◇ (z ◇ z))))
equation 4741 := x = x ◇ (x ◇ (y ◇ (z ◇ (z ◇ w))))
equation 4742 := x = x ◇ (x ◇ (y ◇ (z ◇ (w ◇ x))))
equation 4743 := x = x ◇ (x ◇ (y ◇ (z ◇ (w ◇ y))))
equation 4744 := x = x ◇ (x ◇ (y ◇ (z ◇ (w ◇ z))))
equation 4745 := x = x ◇ (x ◇ (y ◇ (z ◇ (w ◇ w))))
equation 4746 := x = x ◇ (x ◇ (y ◇ (z ◇ (w ◇ u))))
equation 4747 := x = x ◇ (y ◇ (x ◇ (x ◇ (x ◇ x))))
equation 4748 := x = x ◇ (y ◇ (x ◇ (x ◇ (x ◇ y))))
equation 4749 := x = x ◇ (y ◇ (x ◇ (x ◇ (x ◇ z))))
equation 4750 := x = x ◇ (y ◇ (x ◇ (x ◇ (y ◇ x))))
equation 4751 := x = x ◇ (y ◇ (x ◇ (x ◇ (y ◇ y))))
equation 4752 := x = x ◇ (y ◇ (x ◇ (x ◇ (y ◇ z))))
equation 4753 := x = x ◇ (y ◇ (x ◇ (x ◇ (z ◇ x))))
equation 4754 := x = x ◇ (y ◇ (x ◇ (x ◇ (z ◇ y))))
equation 4755 := x = x ◇ (y ◇ (x ◇ (x ◇ (z ◇ z))))
equation 4756 := x = x ◇ (y ◇ (x ◇ (x ◇ (z ◇ w))))
equation 4757 := x = x ◇ (y ◇ (x ◇ (y ◇ (x ◇ x))))
equation 4758 := x = x ◇ (y ◇ (x ◇ (y ◇ (x ◇ y))))
equation 4759 := x = x ◇ (y ◇ (x ◇ (y ◇ (x ◇ z))))
equation 4760 := x = x ◇ (y ◇ (x ◇ (y ◇ (y ◇ x))))
equation 4761 := x = x ◇ (y ◇ (x ◇ (y ◇ (y ◇ y))))
equation 4762 := x = x ◇ (y ◇ (x ◇ (y ◇ (y ◇ z))))
equation 4763 := x = x ◇ (y ◇ (x ◇ (y ◇ (z ◇ x))))
equation 4764 := x = x ◇ (y ◇ (x ◇ (y ◇ (z ◇ y))))
equation 4765 := x = x ◇ (y ◇ (x ◇ (y ◇ (z ◇ z))))
equation 4766 := x = x ◇ (y ◇ (x ◇ (y ◇ (z ◇ w))))
equation 4767 := x = x ◇ (y ◇ (x ◇ (z ◇ (x ◇ x))))
equation 4768 := x = x ◇ (y ◇ (x ◇ (z ◇ (x ◇ y))))
equation 4769 := x = x ◇ (y ◇ (x ◇ (z ◇ (x ◇ z))))
equation 4770 := x = x ◇ (y ◇ (x ◇ (z ◇ (x ◇ w))))
equation 4771 := x = x ◇ (y ◇ (x ◇ (z ◇ (y ◇ x))))
equation 4772 := x = x ◇ (y ◇ (x ◇ (z ◇ (y ◇ y))))
equation 4773 := x = x ◇ (y ◇ (x ◇ (z ◇ (y ◇ z))))
equation 4774 := x = x ◇ (y ◇ (x ◇ (z ◇ (y ◇ w))))
equation 4775 := x = x ◇ (y ◇ (x ◇ (z ◇ (z ◇ x))))
equation 4776 := x = x ◇ (y ◇ (x ◇ (z ◇ (z ◇ y))))
equation 4777 := x = x ◇ (y ◇ (x ◇ (z ◇ (z ◇ z))))
equation 4778 := x = x ◇ (y ◇ (x ◇ (z ◇ (z ◇ w))))
equation 4779 := x = x ◇ (y ◇ (x ◇ (z ◇ (w ◇ x))))
equation 4780 := x = x ◇ (y ◇ (x ◇ (z ◇ (w ◇ y))))
equation 4781 := x = x ◇ (y ◇ (x ◇ (z ◇ (w ◇ z))))
equation 4782 := x = x ◇ (y ◇ (x ◇ (z ◇ (w ◇ w))))
equation 4783 := x = x ◇ (y ◇ (x ◇ (z ◇ (w ◇ u))))
equation 4784 := x = x ◇ (y ◇ (y ◇ (x ◇ (x ◇ x))))
equation 4785 := x = x ◇ (y ◇ (y ◇ (x ◇ (x ◇ y))))
equation 4786 := x = x ◇ (y ◇ (y ◇ (x ◇ (x ◇ z))))
equation 4787 := x = x ◇ (y ◇ (y ◇ (x ◇ (y ◇ x))))
equation 4788 := x = x ◇ (y ◇ (y ◇ (x ◇ (y ◇ y))))
equation 4789 := x = x ◇ (y ◇ (y ◇ (x ◇ (y ◇ z))))
equation 4790 := x = x ◇ (y ◇ (y ◇ (x ◇ (z ◇ x))))
equation 4791 := x = x ◇ (y ◇ (y ◇ (x ◇ (z ◇ y))))
equation 4792 := x = x ◇ (y ◇ (y ◇ (x ◇ (z ◇ z))))
equation 4793 := x = x ◇ (y ◇ (y ◇ (x ◇ (z ◇ w))))
equation 4794 := x = x ◇ (y ◇ (y ◇ (y ◇ (x ◇ x))))
equation 4795 := x = x ◇ (y ◇ (y ◇ (y ◇ (x ◇ y))))
equation 4796 := x = x ◇ (y ◇ (y ◇ (y ◇ (x ◇ z))))
equation 4797 := x = x ◇ (y ◇ (y ◇ (y ◇ (y ◇ x))))
equation 4798 := x = x ◇ (y ◇ (y ◇ (y ◇ (y ◇ y))))
equation 4799 := x = x ◇ (y ◇ (y ◇ (y ◇ (y ◇ z))))
equation 4800 := x = x ◇ (y ◇ (y ◇ (y ◇ (z ◇ x))))
equation 4801 := x = x ◇ (y ◇ (y ◇ (y ◇ (z ◇ y))))
equation 4802 := x = x ◇ (y ◇ (y ◇ (y ◇ (z ◇ z))))
equation 4803 := x = x ◇ (y ◇ (y ◇ (y ◇ (z ◇ w))))
equation 4804 := x = x ◇ (y ◇ (y ◇ (z ◇ (x ◇ x))))
equation 4805 := x = x ◇ (y ◇ (y ◇ (z ◇ (x ◇ y))))
equation 4806 := x = x ◇ (y ◇ (y ◇ (z ◇ (x ◇ z))))
equation 4807 := x = x ◇ (y ◇ (y ◇ (z ◇ (x ◇ w))))
equation 4808 := x = x ◇ (y ◇ (y ◇ (z ◇ (y ◇ x))))
equation 4809 := x = x ◇ (y ◇ (y ◇ (z ◇ (y ◇ y))))
equation 4810 := x = x ◇ (y ◇ (y ◇ (z ◇ (y ◇ z))))
equation 4811 := x = x ◇ (y ◇ (y ◇ (z ◇ (y ◇ w))))
equation 4812 := x = x ◇ (y ◇ (y ◇ (z ◇ (z ◇ x))))
equation 4813 := x = x ◇ (y ◇ (y ◇ (z ◇ (z ◇ y))))
equation 4814 := x = x ◇ (y ◇ (y ◇ (z ◇ (z ◇ z))))
equation 4815 := x = x ◇ (y ◇ (y ◇ (z ◇ (z ◇ w))))
equation 4816 := x = x ◇ (y ◇ (y ◇ (z ◇ (w ◇ x))))
equation 4817 := x = x ◇ (y ◇ (y ◇ (z ◇ (w ◇ y))))
equation 4818 := x = x ◇ (y ◇ (y ◇ (z ◇ (w ◇ z))))
equation 4819 := x = x ◇ (y ◇ (y ◇ (z ◇ (w ◇ w))))
equation 4820 := x = x ◇ (y ◇ (y ◇ (z ◇ (w ◇ u))))
equation 4821 := x = x ◇ (y ◇ (z ◇ (x ◇ (x ◇ x))))
equation 4822 := x = x ◇ (y ◇ (z ◇ (x ◇ (x ◇ y))))
equation 4823 := x = x ◇ (y ◇ (z ◇ (x ◇ (x ◇ z))))
equation 4824 := x = x ◇ (y ◇ (z ◇ (x ◇ (x ◇ w))))
equation 4825 := x = x ◇ (y ◇ (z ◇ (x ◇ (y ◇ x))))
equation 4826 := x = x ◇ (y ◇ (z ◇ (x ◇ (y ◇ y))))
equation 4827 := x = x ◇ (y ◇ (z ◇ (x ◇ (y ◇ z))))
equation 4828 := x = x ◇ (y ◇ (z ◇ (x ◇ (y ◇ w))))
equation 4829 := x = x ◇ (y ◇ (z ◇ (x ◇ (z ◇ x))))
equation 4830 := x = x ◇ (y ◇ (z ◇ (x ◇ (z ◇ y))))
equation 4831 := x = x ◇ (y ◇ (z ◇ (x ◇ (z ◇ z))))
equation 4832 := x = x ◇ (y ◇ (z ◇ (x ◇ (z ◇ w))))
equation 4833 := x = x ◇ (y ◇ (z ◇ (x ◇ (w ◇ x))))
equation 4834 := x = x ◇ (y ◇ (z ◇ (x ◇ (w ◇ y))))
equation 4835 := x = x ◇ (y ◇ (z ◇ (x ◇ (w ◇ z))))
equation 4836 := x = x ◇ (y ◇ (z ◇ (x ◇ (w ◇ w))))
equation 4837 := x = x ◇ (y ◇ (z ◇ (x ◇ (w ◇ u))))
equation 4838 := x = x ◇ (y ◇ (z ◇ (y ◇ (x ◇ x))))
equation 4839 := x = x ◇ (y ◇ (z ◇ (y ◇ (x ◇ y))))
equation 4840 := x = x ◇ (y ◇ (z ◇ (y ◇ (x ◇ z))))
equation 4841 := x = x ◇ (y ◇ (z ◇ (y ◇ (x ◇ w))))
equation 4842 := x = x ◇ (y ◇ (z ◇ (y ◇ (y ◇ x))))
equation 4843 := x = x ◇ (y ◇ (z ◇ (y ◇ (y ◇ y))))
equation 4844 := x = x ◇ (y ◇ (z ◇ (y ◇ (y ◇ z))))
equation 4845 := x = x ◇ (y ◇ (z ◇ (y ◇ (y ◇ w))))
equation 4846 := x = x ◇ (y ◇ (z ◇ (y ◇ (z ◇ x))))
equation 4847 := x = x ◇ (y ◇ (z ◇ (y ◇ (z ◇ y))))
equation 4848 := x = x ◇ (y ◇ (z ◇ (y ◇ (z ◇ z))))
equation 4849 := x = x ◇ (y ◇ (z ◇ (y ◇ (z ◇ w))))
equation 4850 := x = x ◇ (y ◇ (z ◇ (y ◇ (w ◇ x))))
equation 4851 := x = x ◇ (y ◇ (z ◇ (y ◇ (w ◇ y))))
equation 4852 := x = x ◇ (y ◇ (z ◇ (y ◇ (w ◇ z))))
equation 4853 := x = x ◇ (y ◇ (z ◇ (y ◇ (w ◇ w))))
equation 4854 := x = x ◇ (y ◇ (z ◇ (y ◇ (w ◇ u))))
equation 4855 := x = x ◇ (y ◇ (z ◇ (z ◇ (x ◇ x))))
equation 4856 := x = x ◇ (y ◇ (z ◇ (z ◇ (x ◇ y))))
equation 4857 := x = x ◇ (y ◇ (z ◇ (z ◇ (x ◇ z))))
equation 4858 := x = x ◇ (y ◇ (z ◇ (z ◇ (x ◇ w))))
equation 4859 := x = x ◇ (y ◇ (z ◇ (z ◇ (y ◇ x))))
equation 4860 := x = x ◇ (y ◇ (z ◇ (z ◇ (y ◇ y))))
equation 4861 := x = x ◇ (y ◇ (z ◇ (z ◇ (y ◇ z))))
equation 4862 := x = x ◇ (y ◇ (z ◇ (z ◇ (y ◇ w))))
equation 4863 := x = x ◇ (y ◇ (z ◇ (z ◇ (z ◇ x))))
equation 4864 := x = x ◇ (y ◇ (z ◇ (z ◇ (z ◇ y))))
equation 4865 := x = x ◇ (y ◇ (z ◇ (z ◇ (z ◇ z))))
equation 4866 := x = x ◇ (y ◇ (z ◇ (z ◇ (z ◇ w))))
equation 4867 := x = x ◇ (y ◇ (z ◇ (z ◇ (w ◇ x))))
equation 4868 := x = x ◇ (y ◇ (z ◇ (z ◇ (w ◇ y))))
equation 4869 := x = x ◇ (y ◇ (z ◇ (z ◇ (w ◇ z))))
equation 4870 := x = x ◇ (y ◇ (z ◇ (z ◇ (w ◇ w))))
equation 4871 := x = x ◇ (y ◇ (z ◇ (z ◇ (w ◇ u))))
equation 4872 := x = x ◇ (y ◇ (z ◇ (w ◇ (x ◇ x))))
equation 4873 := x = x ◇ (y ◇ (z ◇ (w ◇ (x ◇ y))))
equation 4874 := x = x ◇ (y ◇ (z ◇ (w ◇ (x ◇ z))))
equation 4875 := x = x ◇ (y ◇ (z ◇ (w ◇ (x ◇ w))))
equation 4876 := x = x ◇ (y ◇ (z ◇ (w ◇ (x ◇ u))))
equation 4877 := x = x ◇ (y ◇ (z ◇ (w ◇ (y ◇ x))))
equation 4878 := x = x ◇ (y ◇ (z ◇ (w ◇ (y ◇ y))))
equation 4879 := x = x ◇ (y ◇ (z ◇ (w ◇ (y ◇ z))))
equation 4880 := x = x ◇ (y ◇ (z ◇ (w ◇ (y ◇ w))))
equation 4881 := x = x ◇ (y ◇ (z ◇ (w ◇ (y ◇ u))))
equation 4882 := x = x ◇ (y ◇ (z ◇ (w ◇ (z ◇ x))))
equation 4883 := x = x ◇ (y ◇ (z ◇ (w ◇ (z ◇ y))))
equation 4884 := x = x ◇ (y ◇ (z ◇ (w ◇ (z ◇ z))))
equation 4885 := x = x ◇ (y ◇ (z ◇ (w ◇ (z ◇ w))))
equation 4886 := x = x ◇ (y ◇ (z ◇ (w ◇ (z ◇ u))))
equation 4887 := x = x ◇ (y ◇ (z ◇ (w ◇ (w ◇ x))))
equation 4888 := x = x ◇ (y ◇ (z ◇ (w ◇ (w ◇ y))))
equation 4889 := x = x ◇ (y ◇ (z ◇ (w ◇ (w ◇ z))))
equation 4890 := x = x ◇ (y ◇ (z ◇ (w ◇ (w ◇ w))))
equation 4891 := x = x ◇ (y ◇ (z ◇ (w ◇ (w ◇ u))))
equation 4892 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ x))))
equation 4893 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ y))))
equation 4894 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ z))))
equation 4895 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ w))))
equation 4896 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ u))))
equation 4897 := x = x ◇ (y ◇ (z ◇ (w ◇ (u ◇ v))))
equation 4898 := x = y ◇ (x ◇ (x ◇ (x ◇ (x ◇ x))))
equation 4899 := x = y ◇ (x ◇ (x ◇ (x ◇ (x ◇ y))))
equation 4900 := x = y ◇ (x ◇ (x ◇ (x ◇ (x ◇ z))))
equation 4901 := x = y ◇ (x ◇ (x ◇ (x ◇ (y ◇ x))))
equation 4902 := x = y ◇ (x ◇ (x ◇ (x ◇ (y ◇ y))))
equation 4903 := x = y ◇ (x ◇ (x ◇ (x ◇ (y ◇ z))))
equation 4904 := x = y ◇ (x ◇ (x ◇ (x ◇ (z ◇ x))))
equation 4905 := x = y ◇ (x ◇ (x ◇ (x ◇ (z ◇ y))))
equation 4906 := x = y ◇ (x ◇ (x ◇ (x ◇ (z ◇ z))))
equation 4907 := x = y ◇ (x ◇ (x ◇ (x ◇ (z ◇ w))))
equation 4908 := x = y ◇ (x ◇ (x ◇ (y ◇ (x ◇ x))))
equation 4909 := x = y ◇ (x ◇ (x ◇ (y ◇ (x ◇ y))))
equation 4910 := x = y ◇ (x ◇ (x ◇ (y ◇ (x ◇ z))))
equation 4911 := x = y ◇ (x ◇ (x ◇ (y ◇ (y ◇ x))))
equation 4912 := x = y ◇ (x ◇ (x ◇ (y ◇ (y ◇ y))))
equation 4913 := x = y ◇ (x ◇ (x ◇ (y ◇ (y ◇ z))))
equation 4914 := x = y ◇ (x ◇ (x ◇ (y ◇ (z ◇ x))))
equation 4915 := x = y ◇ (x ◇ (x ◇ (y ◇ (z ◇ y))))
equation 4916 := x = y ◇ (x ◇ (x ◇ (y ◇ (z ◇ z))))
equation 4917 := x = y ◇ (x ◇ (x ◇ (y ◇ (z ◇ w))))
equation 4918 := x = y ◇ (x ◇ (x ◇ (z ◇ (x ◇ x))))
equation 4919 := x = y ◇ (x ◇ (x ◇ (z ◇ (x ◇ y))))
equation 4920 := x = y ◇ (x ◇ (x ◇ (z ◇ (x ◇ z))))
equation 4921 := x = y ◇ (x ◇ (x ◇ (z ◇ (x ◇ w))))
equation 4922 := x = y ◇ (x ◇ (x ◇ (z ◇ (y ◇ x))))
equation 4923 := x = y ◇ (x ◇ (x ◇ (z ◇ (y ◇ y))))
equation 4924 := x = y ◇ (x ◇ (x ◇ (z ◇ (y ◇ z))))
equation 4925 := x = y ◇ (x ◇ (x ◇ (z ◇ (y ◇ w))))
equation 4926 := x = y ◇ (x ◇ (x ◇ (z ◇ (z ◇ x))))
equation 4927 := x = y ◇ (x ◇ (x ◇ (z ◇ (z ◇ y))))
equation 4928 := x = y ◇ (x ◇ (x ◇ (z ◇ (z ◇ z))))
equation 4929 := x = y ◇ (x ◇ (x ◇ (z ◇ (z ◇ w))))
equation 4930 := x = y ◇ (x ◇ (x ◇ (z ◇ (w ◇ x))))
equation 4931 := x = y ◇ (x ◇ (x ◇ (z ◇ (w ◇ y))))
equation 4932 := x = y ◇ (x ◇ (x ◇ (z ◇ (w ◇ z))))
equation 4933 := x = y ◇ (x ◇ (x ◇ (z ◇ (w ◇ w))))
equation 4934 := x = y ◇ (x ◇ (x ◇ (z ◇ (w ◇ u))))
equation 4935 := x = y ◇ (x ◇ (y ◇ (x ◇ (x ◇ x))))
equation 4936 := x = y ◇ (x ◇ (y ◇ (x ◇ (x ◇ y))))
equation 4937 := x = y ◇ (x ◇ (y ◇ (x ◇ (x ◇ z))))
equation 4938 := x = y ◇ (x ◇ (y ◇ (x ◇ (y ◇ x))))
equation 4939 := x = y ◇ (x ◇ (y ◇ (x ◇ (y ◇ y))))
equation 4940 := x = y ◇ (x ◇ (y ◇ (x ◇ (y ◇ z))))
equation 4941 := x = y ◇ (x ◇ (y ◇ (x ◇ (z ◇ x))))
equation 4942 := x = y ◇ (x ◇ (y ◇ (x ◇ (z ◇ y))))
equation 4943 := x = y ◇ (x ◇ (y ◇ (x ◇ (z ◇ z))))
equation 4944 := x = y ◇ (x ◇ (y ◇ (x ◇ (z ◇ w))))
equation 4945 := x = y ◇ (x ◇ (y ◇ (y ◇ (x ◇ x))))
equation 4946 := x = y ◇ (x ◇ (y ◇ (y ◇ (x ◇ y))))
equation 4947 := x = y ◇ (x ◇ (y ◇ (y ◇ (x ◇ z))))
equation 4948 := x = y ◇ (x ◇ (y ◇ (y ◇ (y ◇ x))))
equation 4949 := x = y ◇ (x ◇ (y ◇ (y ◇ (y ◇ y))))
equation 4950 := x = y ◇ (x ◇ (y ◇ (y ◇ (y ◇ z))))
equation 4951 := x = y ◇ (x ◇ (y ◇ (y ◇ (z ◇ x))))
equation 4952 := x = y ◇ (x ◇ (y ◇ (y ◇ (z ◇ y))))
equation 4953 := x = y ◇ (x ◇ (y ◇ (y ◇ (z ◇ z))))
equation 4954 := x = y ◇ (x ◇ (y ◇ (y ◇ (z ◇ w))))
equation 4955 := x = y ◇ (x ◇ (y ◇ (z ◇ (x ◇ x))))
equation 4956 := x = y ◇ (x ◇ (y ◇ (z ◇ (x ◇ y))))
equation 4957 := x = y ◇ (x ◇ (y ◇ (z ◇ (x ◇ z))))
equation 4958 := x = y ◇ (x ◇ (y ◇ (z ◇ (x ◇ w))))
equation 4959 := x = y ◇ (x ◇ (y ◇ (z ◇ (y ◇ x))))
equation 4960 := x = y ◇ (x ◇ (y ◇ (z ◇ (y ◇ y))))
equation 4961 := x = y ◇ (x ◇ (y ◇ (z ◇ (y ◇ z))))
equation 4962 := x = y ◇ (x ◇ (y ◇ (z ◇ (y ◇ w))))
equation 4963 := x = y ◇ (x ◇ (y ◇ (z ◇ (z ◇ x))))
equation 4964 := x = y ◇ (x ◇ (y ◇ (z ◇ (z ◇ y))))
equation 4965 := x = y ◇ (x ◇ (y ◇ (z ◇ (z ◇ z))))
equation 4966 := x = y ◇ (x ◇ (y ◇ (z ◇ (z ◇ w))))
equation 4967 := x = y ◇ (x ◇ (y ◇ (z ◇ (w ◇ x))))
equation 4968 := x = y ◇ (x ◇ (y ◇ (z ◇ (w ◇ y))))
equation 4969 := x = y ◇ (x ◇ (y ◇ (z ◇ (w ◇ z))))
equation 4970 := x = y ◇ (x ◇ (y ◇ (z ◇ (w ◇ w))))
equation 4971 := x = y ◇ (x ◇ (y ◇ (z ◇ (w ◇ u))))
equation 4972 := x = y ◇ (x ◇ (z ◇ (x ◇ (x ◇ x))))
equation 4973 := x = y ◇ (x ◇ (z ◇ (x ◇ (x ◇ y))))
equation 4974 := x = y ◇ (x ◇ (z ◇ (x ◇ (x ◇ z))))
equation 4975 := x = y ◇ (x ◇ (z ◇ (x ◇ (x ◇ w))))
equation 4976 := x = y ◇ (x ◇ (z ◇ (x ◇ (y ◇ x))))
equation 4977 := x = y ◇ (x ◇ (z ◇ (x ◇ (y ◇ y))))
equation 4978 := x = y ◇ (x ◇ (z ◇ (x ◇ (y ◇ z))))
equation 4979 := x = y ◇ (x ◇ (z ◇ (x ◇ (y ◇ w))))
equation 4980 := x = y ◇ (x ◇ (z ◇ (x ◇ (z ◇ x))))
equation 4981 := x = y ◇ (x ◇ (z ◇ (x ◇ (z ◇ y))))
equation 4982 := x = y ◇ (x ◇ (z ◇ (x ◇ (z ◇ z))))
equation 4983 := x = y ◇ (x ◇ (z ◇ (x ◇ (z ◇ w))))
equation 4984 := x = y ◇ (x ◇ (z ◇ (x ◇ (w ◇ x))))
equation 4985 := x = y ◇ (x ◇ (z ◇ (x ◇ (w ◇ y))))
equation 4986 := x = y ◇ (x ◇ (z ◇ (x ◇ (w ◇ z))))
equation 4987 := x = y ◇ (x ◇ (z ◇ (x ◇ (w ◇ w))))
equation 4988 := x = y ◇ (x ◇ (z ◇ (x ◇ (w ◇ u))))
equation 4989 := x = y ◇ (x ◇ (z ◇ (y ◇ (x ◇ x))))
equation 4990 := x = y ◇ (x ◇ (z ◇ (y ◇ (x ◇ y))))
equation 4991 := x = y ◇ (x ◇ (z ◇ (y ◇ (x ◇ z))))
equation 4992 := x = y ◇ (x ◇ (z ◇ (y ◇ (x ◇ w))))
equation 4993 := x = y ◇ (x ◇ (z ◇ (y ◇ (y ◇ x))))
equation 4994 := x = y ◇ (x ◇ (z ◇ (y ◇ (y ◇ y))))
equation 4995 := x = y ◇ (x ◇ (z ◇ (y ◇ (y ◇ z))))
equation 4996 := x = y ◇ (x ◇ (z ◇ (y ◇ (y ◇ w))))
equation 4997 := x = y ◇ (x ◇ (z ◇ (y ◇ (z ◇ x))))
equation 4998 := x = y ◇ (x ◇ (z ◇ (y ◇ (z ◇ y))))
equation 4999 := x = y ◇ (x ◇ (z ◇ (y ◇ (z ◇ z))))
